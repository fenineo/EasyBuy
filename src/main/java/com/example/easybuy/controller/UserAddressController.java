...
public class UserAddressController {
     ...
     */
    @ApiOperation("查询收货地址")
    @RequestMapping(value = "/regist/findByUserId",method = RequestMethod.GET)
     ...
     */
    @ApiOperation("添加收货地址")
    @RequestMapping(value = "/regist/addUserAddress",method = RequestMethod.GET)
     ...
     */
    @ApiOperation("删除收货地址")
    @RequestMapping(value = "/regist/removeUserAddress",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/regist/findById",method = RequestMethod.GET)
     ...
     */
    @ApiOperation("修改收货地址")
    @RequestMapping(value = "/regist/modifyUserAddress",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/regist/allisDefault",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/regist/isDefault",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/regist/findByUser",method = RequestMethod.GET)
